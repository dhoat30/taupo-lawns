...
export const HomeOneSliderItem:THero[]  = [
    {
        id: 1,
        sliderBg: heroImg1,
        sliderSubtitle: 'Keep your lawn looking its best all year round with professional mowing and maintenance services. Taupo Lawns delivers reliable, affordable, and tailored solutions to give your outdoor spaces the perfect finish.',
        sliderTitle: "Taupo's Trusted Lawn Care Experts",
...
export const HomeTwoSliderItem:THeroTwo[] = [
    {
        id: 1,
        sliderBg: banner1,
        sliderSubtitle:`[Serving since 2014 ]`,
        sliderTitle: "Taupo's Trusted Lawn Care Experts",
        sliderDesc: 'Keep your lawn looking its best all year round with professional mowing and maintenance services. Taupo Lawns delivers reliable, affordable, and tailored solutions to give your outdoor spaces the perfect finish.',
        slidereviewImg: reviewThumb,
        slidereviewText: 'Google Rating',
        slidereviewCount: '4.9',
    ...
    },
    {
        ...
        sliderBg: banner2,
        sliderSubtitle: `[Serving since 2014 ]`,
        sliderTitle: "Lawn Mowing Services",
        sliderDesc: 'Keep your lawn looking its best all year round with professional mowing and maintenance services. Taupo Lawns delivers reliable, affordable, and tailored solutions to give your outdoor spaces the perfect finish.',
        slidereviewImg: reviewThumb,
        slidereviewText: 'Google Rating',
        slidereviewCount: '4.9',
